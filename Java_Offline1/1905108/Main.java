...
public class Main {
	...
	System.out.print("ClubCount: ");
	clubCount=sc.nextInt();
	System.out.print("LeagueCount: ");
	leagueCount=sc.nextInt();
        ...
        int leagueIndex = 0;
        int clubIndex = 0;
        // taking clubIndex and leagueIndex as input (optional)
        System.out.print("LeagueIndex: ");
        leagueIndex=sc.nextInt();
        System.out.print("ClubIndex: ");
